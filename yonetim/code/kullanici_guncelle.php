...
$sql = "UPDATE kullanicilar SET rol = '$rol' WHERE id = $id";
...
if ($ornek) {
    echo "<div class='alert alert-success d-flex align-items-center mb-4'><i class='bi bi-check-circle-fill fs-4 me-2'></i> <div><strong>Başarılı!</strong> Kullanıcı yetkisi başarıyla güncellendi.</div></div>";
} else {
