<?php
$ad = mysqli_real_escape_string($conn, $_GET["ad"]);

$sql = "INSERT INTO kategoriler (ad) VALUES ('$ad')";
...
if ($ornek) {
    echo "<div class='alert alert-success d-flex align-items-center mb-4'><i class='bi bi-check-circle-fill fs-4 me-2'></i> <div><strong>Başarılı!</strong> Kategori başarıyla eklendi.</div></div>";
} else {
...
<div class="card p-3 shadow-sm mt-3">
    <div class="card-body py-2">
        Kategoriler sayfasına dönmek için <a href="?sayfa=kategoriler" class="btn btn-outline-primary btn-sm ms-2"><i class="bi bi-arrow-left me-1"></i> Tıklayınız</a>
    </div>
</div>
