...
if (!is_null($id)) {
    ...
    if ($ornek) {
        echo "<div class='alert alert-success d-flex align-items-center mb-4'><i class='bi bi-check-circle-fill fs-4 me-2'></i> <div><strong>Başarılı!</strong> Araç başarıyla silindi.</div></div>";
    } else {
